...
class FormularioProduto extends StatefulWidget {
  ...
  @override
  State<FormularioProduto> createState() => _FormularioProduto();
}

class _FormularioProduto extends State<FormularioProduto> {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  // print('id: ${idContoller.text}');
                  // print('id: ${descricaoController.text}');
                  if (formKey.currentState!.validate()) {
                    context.read<MyChangeNotifer>().produtos.add(
                      Produto(id: int.parse(idContoller.text), descricao: descricaoController.text, preco: double.parse(precoController.text)),
                    );
                  }
                },
                child: Text('Submeter'),
